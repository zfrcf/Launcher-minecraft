...
This copy is configured for Minecraft **1.21.11** and Microsoft authentication.
It can communicate with compatible Java servers over the project's WebSocket-to-TCP bridge.
It is **not** a Fabric Loader/client and does not load Fabric client-side mods.
