// Bruit de Perlin simplex 2D/3D avec graine (seed) déterministe.
// Utilisé par le générateur de terrain côté client ET côté hôte : la même graine
// produit exactement le même monde partout.
(function (MC) {
  'use strict';
  ...
  // Hash entier déterministe (pour placer arbres, minerais, etc.)
